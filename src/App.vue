...
export default {
      ...
      flags: [
        {
          name: "Brasil",
          idioma: "Brasil",
          flag: "src/assets/images/flag-brazil.png",
          translations:
        ...
        },
        {
          name: "Estados Unidos",
          idioma: "Inglês",
          flag: "src/assets/images/flag-united-states.png",
          translations:
  ...
  methods: {
    handleClick(language) {
      ...
      if (language == "Brasil") {
        this.selected = this.flags[0].translations;
      } else if (language == "Espanhol") {
        this.selected = this.flags[1].translations;
      } else {
        this.selected = this.flags[2].translations;
      }
    },
  },
};
